...
**Ключевая бизнес-задача:** определить, кто с высокой вероятностью совершит покупку или вернётся к активности в ближайшее время.

**Данные:** датасет [FAR-Trans](https://github.com/sanzcruz/FAR-Trans) — транзакционная история инвестиционных операций ~29 000 клиентов с 2018 по 2022 год.

---

## Архитектура

Финальная версия реализована как **двухмодельная посегментная система**:
